...
conv2_dw = tf.nn.depthwise_conv2d(conv1,    conv2_dw_filters, [1,2,2,1], 'VALID')
conv2_pw = tf.nn.conv2d(          conv2_dw, conv2_pw_filters, [1,1,1,1], 'VALID')
conv3_dw = tf.nn.depthwise_conv2d(conv2_pw, conv3_dw_filters, [1,1,1,1], 'VALID')
conv3_pw = tf.nn.conv2d(          conv3_dw, conv3_pw_filters, [1,1,1,1], 'VALID')

conv4_dw = tf.nn.depthwise_conv2d(conv3_pw, conv4_dw_filters, [1,2,2,1], 'VALID')
conv4_pw = tf.nn.conv2d(          conv4_dw, conv4_pw_filters, [1,1,1,1], 'VALID')
conv5_dw = tf.nn.depthwise_conv2d(conv4_pw, conv5_dw_filters, [1,1,1,1], 'VALID')
conv5_pw = tf.nn.conv2d(          conv5_dw, conv5_pw_filters, [1,1,1,1], 'VALID')

conv6_dw = tf.nn.depthwise_conv2d(conv5_pw, conv6_dw_filters, [1,2,2,1], 'VALID')
conv6_pw = tf.nn.conv2d(          conv6_dw, conv6_pw_filters, [1,1,1,1], 'VALID')
conv7_dw = tf.nn.depthwise_conv2d(conv6_pw, conv7_dw_filters, [1,1,1,1], 'VALID')
conv7_pw = tf.nn.conv2d(          conv7_dw, conv7_pw_filters, [1,1,1,1], 'VALID')

conv8_dw = tf.nn.depthwise_conv2d(conv7_pw, conv8_dw_filters, [1,1,1,1], 'VALID')
conv8_pw = tf.nn.conv2d(          conv8_dw, conv8_pw_filters, [1,1,1,1], 'VALID')
conv9_dw = tf.nn.depthwise_conv2d(conv8_pw, conv9_dw_filters, [1,1,1,1], 'VALID')
conv9_pw = tf.nn.conv2d(          conv9_dw, conv9_pw_filters, [1,1,1,1], 'VALID')
